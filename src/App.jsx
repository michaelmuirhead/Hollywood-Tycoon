...
const CURATED_NPCS = [
  // ============================================================
  // ACTORS — 50 male leads spanning every archetype, age, and tier
  // ============================================================
  ...
  { name: 'Antonio Marchetti', role: 'actor', gender: 'male', archetype: 'Method Star', age: 53, fame: 84, bio: 'Lived in a tenement for six months for his role in Hell\'s Kitchen. The other tenants complained he was too in-character.', trajectory: 0 },
  { name: 'Bruce Tanaka', role: 'actor', gender: 'male', archetype: 'Action Hero', age: 38, fame: 76, bio: 'Martial arts world champion before he was an actor. Studios pitch him every action script. He picks one in three.', trajectory: 1 },
  { name: 'Sidney Washington', role: 'actor', gender: 'male', archetype: 'Awards Magnet', age: 58, fame: 92, bio: 'First Black actor to win Best Actor twice. Refuses to play stereotypes. Refuses to play villains. Has the contract clause to enforce it.', trajectory: 0 },
  { name: 'Diego Mendoza', role: 'actor', gender: 'male', archetype: 'Box Office Draw', age: 41, fame: 78, bio: 'Crossover star from Mexican cinema. Did three telenovelas before Hollywood called. Still goes home every Christmas.', trajectory: 1 },
  { name: 'Saul Mandelbaum', role: 'actor', gender: 'male', archetype: 'Comedy Icon', age: 64, fame: 73, bio: 'Borscht Belt to Broadway to film. Forty years of one-liners. Slowing down but the punchlines still land.', trajectory: -1 },
  { name: 'Charles Whitlock', role: 'actor', gender: 'male', archetype: 'Industry Veteran', age: 72, fame: 60, bio: 'Was in three of the top-grossing pictures of the 50s. Now mostly does small parts in his friends\' films. Beloved by everyone.', trajectory: -1 },
  { name: 'Lorenzo Esposito', role: 'actor', gender: 'male', archetype: 'Critics\' Darling', age: 35, fame: 58, bio: 'Italian-American intensity. Three festival prizes, zero blockbusters. Recently turned down a $5M paycheck for a paint-by-numbers thriller.', trajectory: 1 },
  { name: 'Mordecai Levin', role: 'actor', gender: 'male', archetype: 'Method Star', age: 44, fame: 65, bio: 'Trained with Strasberg. Doesn\'t break character on set, even between takes. Crew gives him a wide berth and a chair with his character\'s name.', trajectory: 0 },
  { name: 'Tyrone Banks', role: 'actor', gender: 'male', archetype: 'Box Office Draw', age: 32, fame: 80, bio: 'Action-comedy hybrid. Started as a stand-up. Three of his last four films cleared $100M. Studios are scared he\'ll renegotiate.', trajectory: 1 },
  { name: 'Kirk Halloran', role: 'actor', gender: 'male', archetype: 'Has-Been', age: 56, fame: 28, bio: 'A-list at thirty, washed up at forty. Did one cocaine bust too many. Sober now. Looking for the comeback role.', trajectory: -1 },
  { name: 'Eugene Pemberton', role: 'actor', gender: 'male', archetype: 'Studio Workhorse', age: 49, fame: 55, bio: 'Five films a year. Three are forgettable, one is fine, one is great. Studios cast him because he never says no.', trajectory: 0 },
  { name: 'Vito Bonetti', role: 'actor', gender: 'male', archetype: 'Action Hero', age: 47, fame: 71, bio: 'Plays cops and criminals in equal measure. Won a screen-fighting award no one\'s ever heard of. Wears it as a belt buckle.', trajectory: 0 },
  { name: 'Howard Carrington', role: 'actor', gender: 'male', archetype: 'Fading Star', age: 65, fame: 38, bio: 'Was the studio\'s answer to Cary Grant in 1962. Now does a TV movie a year and a Vegas residency. Hates them both.', trajectory: -1 },
  { name: 'Lee Park', role: 'actor', gender: 'male', archetype: 'Up-and-Comer', age: 24, fame: 32, bio: 'Born in Seoul, raised in LA. Just got nominated for an indie that two thousand people have actually seen. The town is paying attention.', trajectory: 1 },
  { name: 'Frank Coleman', role: 'actor', gender: 'male', archetype: 'Comedy Icon', age: 43, fame: 76, bio: 'Late-night TV host turned movie star. The talk show is still on the air. He films pictures on his hiatus weeks. Sleeps four hours a night.', trajectory: 1 },
  { name: 'Vincent Halloran', role: 'actor', gender: 'male', archetype: 'Method Star', age: 39, fame: 70, bio: 'Lost forty pounds for one role, gained it back for another. Doctor begged him to stop. He listened for one picture, then started again.', trajectory: 0 },
  { name: 'Walter Beaumont', role: 'actor', gender: 'male', archetype: 'Industry Veteran', age: 68, fame: 78, bio: 'Last working contract player from the studio era. Has worked with everyone. Tells the same five stories at every premiere.', trajectory: -1 },
  { name: 'James Robinson', role: 'actor', gender: 'male', archetype: 'Critics\' Darling', age: 42, fame: 67, bio: 'Started in regional theater, broke through at thirty-five with a Cassavetes-esque indie. Won\'t do TV. Won\'t do voiceover.', trajectory: 0 },
  { name: 'Errol Sinclair', role: 'actor', gender: 'male', archetype: 'Box Office Draw', age: 36, fame: 81, bio: 'Buccaneer charm in the era of leather jackets. Plays heroes who smile during the gunfight. Sells popcorn.', trajectory: 0 },
  { name: 'Edward Whitmore', role: 'actor', gender: 'male', archetype: 'Awards Magnet', age: 52, fame: 86, bio: 'Two Oscar wins, six nominations. Plays presidents, generals, and tortured patriarchs. Won\'t touch comedy.', trajectory: 0 },
  { name: 'Carlos Rivera', role: 'actor', gender: 'male', archetype: 'Up-and-Comer', age: 28, fame: 42, bio: 'Soap opera heartthrob breaking into film. Playing against type in everything. Fans miss the soap. Critics don\'t.', trajectory: 1 },
  { name: 'Jack Halloran', role: 'actor', gender: 'male', archetype: 'Studio Workhorse', age: 46, fame: 52, bio: 'The guy you cast when you need someone to play "the friend." Never been the lead. Owns a vineyard. Doesn\'t care.', trajectory: 0 },
  { name: 'Stanley Booker', role: 'actor', gender: 'male', archetype: 'Comedy Icon', age: 55, fame: 64, bio: 'Pratfall master. Did his own stunts even in the comedies. Knees are wrecked. Still lives for the laughs.', trajectory: 0 },
  { name: 'Sol Goldberg', role: 'actor', gender: 'male', archetype: 'Industry Veteran', age: 70, fame: 50, bio: 'A working actor since 1948. Was almost the lead in Casablanca, the story goes. He tells it differently every time.', trajectory: -1 },
  { name: 'Robert Cassidy', role: 'actor', gender: 'male', archetype: 'Method Star', age: 31, fame: 62, bio: 'Read every word ever written about his last role. Conducted his own field research for the one before. Burns out between projects.', trajectory: 1 },
  { name: 'Marlon Crawford', role: 'actor', gender: 'male', archetype: 'Awards Magnet', age: 49, fame: 88, bio: 'Refuses interviews, refuses publicity, won the Oscar anyway. The most photographed man in town because he hides from photographers.', trajectory: 0 },
  { name: 'Paolo Ferrara', role: 'actor', gender: 'male', archetype: 'Critics\' Darling', age: 44, fame: 60, bio: 'Roman by birth, NYU-trained. Plays gangsters and priests with equal conviction. Fluent in five languages.', trajectory: 0 },
  { name: 'Murray Rosenthal', role: 'actor', gender: 'male', archetype: 'Comedy Icon', age: 60, fame: 68, bio: 'Sketch comedy legend in the 60s. Made the leap to film in the 70s. Has a one-man show running on Broadway six weeks a year.', trajectory: -1 },
  { name: 'Spencer Devereaux', role: 'actor', gender: 'male', archetype: 'Box Office Draw', age: 41, fame: 84, bio: 'Action lead with a brain. Reads philosophy on set. Critics call him "underrated." Studios call him a guaranteed opening weekend.', trajectory: 1 },
  { name: 'Luigi D\'Angelo', role: 'actor', gender: 'male', archetype: 'Up-and-Comer', age: 25, fame: 35, bio: 'Stage actor from Chicago, just landed his first feature. Industry buzz says he\'s the next Method Star. He hates the comparison.', trajectory: 1 },
  { name: 'Harry Booker', role: 'actor', gender: 'male', archetype: 'Action Hero', age: 51, fame: 67, bio: 'Cop movies are his lane. Has played a detective in twenty-three films. Six were good. Four were great. The rest paid the bills.', trajectory: 0 },
  { name: 'Cary Sinclair', role: 'actor', gender: 'male', archetype: 'Industry Veteran', age: 64, fame: 72, bio: 'Romantic lead in three decades, fading patriarch in the fourth. Career so long it lapped trends. Still gets fan mail from the 60s.', trajectory: -1 },
  { name: 'Arthur Pemberton', role: 'actor', gender: 'male', archetype: 'Has-Been', age: 53, fame: 25, bio: 'Was a teen idol in 1967. Spent the 70s in a rehab cycle. Comeback was scheduled twice. Still working on it.', trajectory: -1 },
  { name: 'Joseph Esposito', role: 'actor', gender: 'male', archetype: 'Studio Workhorse', age: 48, fame: 56, bio: 'The reliable second lead. Has worked with every A-list actress in town and made all of them look good. Award presenters never call his name.', trajectory: 0 },
  { name: 'Salvatore Castellano', role: 'actor', gender: 'male', archetype: 'Method Star', age: 36, fame: 71, bio: 'Spent six weeks in a Sicilian fishing village to prepare for one scene. The director still calls him about it.', trajectory: 1 },
  { name: 'Howard Sterling', role: 'actor', gender: 'male', archetype: 'Critics\' Darling', age: 50, fame: 64, bio: 'European art-house imports cast him in their American debuts. Three obscure festival wins. The town doesn\'t know what to do with him.', trajectory: 0 },
  { name: 'Reese Booker', role: 'actor', gender: 'male', archetype: 'Box Office Draw', age: 33, fame: 75, bio: 'The new face of the action-romance. Six-foot-three, runs in the trailer, kisses in the third act. Three-picture deal at Paramount.', trajectory: 1 },
  { name: 'Tyrone Whitlock', role: 'actor', gender: 'male', archetype: 'Awards Magnet', age: 47, fame: 81, bio: 'Played MLK off-Broadway, played Othello at the Public, won an Oscar for a film about neither. Career trajectory: vertical.', trajectory: 0 },
  { name: 'Bishop Carrington', role: 'actor', gender: 'male', archetype: 'Comedy Icon', age: 39, fame: 69, bio: 'SNL alumnus, writes his own material. Three of his comedies cleared the $50M mark. Studios send him their failed dramas to "make funny."', trajectory: 1 },
  { name: 'Forrest Calloway', role: 'actor', gender: 'male', archetype: 'Up-and-Comer', age: 27, fame: 40, bio: 'Cornell-educated, started in regional Shakespeare. Got the lead in a sleeper indie. Already signed for a major studio picture.', trajectory: 1 },
  { name: 'Henry Marlowe', role: 'actor', gender: 'male', archetype: 'Fading Star', age: 59, fame: 42, bio: 'A sex symbol in the 70s. Didn\'t age into character roles gracefully. Books TV movies. Wishes for one last great script.', trajectory: -1 },
  { name: 'Marcus Sokolov', role: 'actor', gender: 'male', archetype: 'Method Star', age: 43, fame: 73, bio: 'Refuses to read ahead in the script. Wants to discover his character\'s fate the same week the audience would. Drives directors crazy.', trajectory: 0 },
  { name: 'William Frost', role: 'actor', gender: 'male', archetype: 'Industry Veteran', age: 66, fame: 65, bio: 'Hasn\'t taken a year off since 1958. Forty-seven films and counting. Sleeps on planes. Owns no pets. Has three ex-wives.', trajectory: -1 },

  // ============================================================
  // ACTRESSES — 50 female leads spanning every archetype
  // ============================================================
  { name: 'Vivienne Sterling', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 42, fame: 90, bio: 'Three Oscars. Two divorces from her directors. Picks the impossible material and does the impossible thing with it.', trajectory: 0 },
  { name: 'Margot Crewe', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 35, fame: 75, bio: 'Indie queen. Refused studio money for ten years and counting. Just signed her first big-budget picture. Everyone has opinions.', trajectory: 1 },
  { name: 'Naomi Ashford', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 31, fame: 82, bio: 'Action heroine. Broke out of a 1983 sci-fi picture. Negotiates her own contracts. Studios have learned not to lowball her.', trajectory: 1 },
  { name: 'Eleanor Voss', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 67, fame: 68, bio: 'Studio system survivor. Mentored half the current A-list. Doesn\'t suffer fools, doesn\'t do morning shows, doesn\'t need to.', trajectory: -1 },
  { name: 'Rosalind Pierce', role: 'actor', gender: 'female', archetype: 'Method Star', age: 28, fame: 55, bio: 'Difficult on set. Worth it. Three nominations in five years. Costars either adore her or never speak her name again.', trajectory: 1 },
  { name: 'Diane Holloway', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 38, fame: 70, bio: 'Romcom queen of the early 80s. Wants to direct. Has a script. Has a backer. Studio is "circling."', trajectory: 0 },
  { name: 'Cicely Coleman', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 49, fame: 62, bio: 'The actress every other actress wants to play opposite. A working career built on impossible scenes done in one take.', trajectory: 0 },
  { name: 'Sofia Marchetti', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 44, fame: 87, bio: 'Italian transplant. Won Best Actress for her first English-language role. Hollywood couldn\'t pronounce her name. Now they can.', trajectory: 0 },
  { name: 'Anna Tanaka', role: 'actor', gender: 'female', archetype: 'Up-and-Comer', age: 25, fame: 38, bio: 'Half-Japanese, all New York attitude. Theater-trained. Just got her first studio offer. Asked to read the contract herself.', trajectory: 1 },
  { name: 'Diahann Washington', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 60, fame: 78, bio: 'Broke through in the late 60s when there were three roles a year for Black women. Made all of them sing. Still does.', trajectory: 0 },
  { name: 'Carmen Rivera', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 36, fame: 76, bio: 'Crossover from Spanish-language television. Dance background. Did her own choreography in the smash-hit musical.', trajectory: 1 },
  { name: 'Esther Levin', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 41, fame: 60, bio: 'Off-Broadway royalty. Refuses to do studio movies. Made an exception once for a friend. Got nominated for it.', trajectory: 0 },
  { name: 'Bette Marlowe', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 71, fame: 72, bio: 'Studio contract player from 1937. Outlived three husbands and two studios. Still books a film a year. The town owes her.', trajectory: -1 },
  { name: 'Lana Cassidy', role: 'actor', gender: 'female', archetype: 'Comedy Icon', age: 48, fame: 73, bio: 'Sketch-comedy alumna with five films grossing over $50M. Writes her own material. Studios don\'t change a comma.', trajectory: 0 },
  { name: 'Greta Sokolov', role: 'actor', gender: 'female', archetype: 'Method Star', age: 33, fame: 68, bio: 'Trained in Moscow before defecting in 1979. Plays haunted women. Has actually been one. Now and then.', trajectory: 1 },
  { name: 'Audrey Bellamy', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 56, fame: 84, bio: 'Two Oscars. Married to her co-star from the second one. They live in Connecticut. Take a film a year.', trajectory: 0 },
  { name: 'Lucia Esposito', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 29, fame: 78, bio: 'The sex symbol of her generation. Smarter than the press credits her for. Bought the production company that owned her contract.', trajectory: 1 },
  { name: 'Joan Whitlock', role: 'actor', gender: 'female', archetype: 'Has-Been', age: 54, fame: 30, bio: 'Was the It Girl of 1972. Disappeared after a scandal nobody can fully reconstruct. Recently spotted at a casting director\'s office.', trajectory: -1 },
  { name: 'Hazel Pemberton', role: 'actor', gender: 'female', archetype: 'Studio Workhorse', age: 46, fame: 50, bio: 'Eight films a year. Mostly TV movies. Steady paycheck, no pretensions. Her agent calls her "the hardest-working woman in show business."', trajectory: 0 },
  { name: 'Mei Chen', role: 'actor', gender: 'female', archetype: 'Up-and-Comer', age: 26, fame: 35, bio: 'Hong Kong cinema star making the jump. Three of the biggest Cantonese hits of the early 80s. Studios are figuring out what to do with her.', trajectory: 1 },
  { name: 'Beatrice Halford', role: 'actor', gender: 'female', archetype: 'Fading Star', age: 58, fame: 40, bio: 'A leading lady through the 70s. Now offered "the mother" in everything. Took a Broadway run instead. Won the Tony.', trajectory: -1 },
  { name: 'Constance Whitmore', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 39, fame: 58, bio: 'Plays cold, brilliant, complicated women. Critics adore her. The Academy keeps almost-nominating her. She\'ll get there.', trajectory: 0 },
  { name: 'Renata Cabrera', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 32, fame: 80, bio: 'Telenovela star turned international action lead. Negotiated points on the back end before any agent told her to.', trajectory: 1 },
  { name: 'Gabriela Santiago', role: 'actor', gender: 'female', archetype: 'Method Star', age: 37, fame: 65, bio: 'Lived undocumented in LA for the role that made her career. Refuses to discuss it on camera. Discusses it on every page of her memoir.', trajectory: 1 },
  { name: 'Florence Ardent', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 73, fame: 58, bio: 'Five decades of supporting roles. Played the mother, the aunt, the witch, the queen, and the corpse. All beautifully.', trajectory: -1 },
  { name: 'Ruth Goldberg', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 51, fame: 86, bio: 'New York stage royalty before her first film. Won Best Actress on her third try. Now picks one role every two years.', trajectory: 0 },
  { name: 'Phylicia Banks', role: 'actor', gender: 'female', archetype: 'Comedy Icon', age: 43, fame: 68, bio: 'Sitcom queen who proved she could open a movie. Five years on a top-rated show. Three blockbuster comedies since.', trajectory: 1 },
  { name: 'Margaret Halloran', role: 'actor', gender: 'female', archetype: 'Studio Workhorse', age: 50, fame: 52, bio: 'A Western specialist when there are westerns. A noir specialist when there are noirs. Mostly TV pilots now. Pays the mortgage.', trajectory: 0 },
  { name: 'Adelaide Wexler', role: 'actor', gender: 'female', archetype: 'Up-and-Comer', age: 23, fame: 45, bio: 'Modeling-agency kid who took an acting class at twenty and discovered she\'s good. Three offers on her desk. Hasn\'t signed anything yet.', trajectory: 1 },
  ...
  { name: 'Ruby Coleman', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 35, fame: 84, bio: 'The most bankable Black actress in town. Studios open films around her name. Producers know not to call without an offer above $2M.', trajectory: 1 },
  { name: 'Miriam Mandelbaum', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 60, fame: 70, bio: 'A working actress for forty years. Won Best Supporting Actress on her seventh nomination. Still says she got lucky.', trajectory: -1 },
  { name: 'Dorothy Sinclair', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 75, fame: 60, bio: 'Was the studio\'s answer to Audrey Hepburn in 1959. Now grand dame parts. Refuses to play "wise old woman who dies in act two."', trajectory: -1 },
  { name: 'Ingrid Lamont', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 38, fame: 56, bio: 'Scandinavian art-house import. Her first American film was a flop. Her second won Cannes. Her third is "in development" for the third year.', trajectory: 0 },
  { name: 'Helen Frost', role: 'actor', gender: 'female', archetype: 'Studio Workhorse', age: 52, fame: 45, bio: 'Television movie of the week is her bread and butter. Three a year. Audiences adore her. Critics never review her. She knows the deal.', trajectory: 0 },
  { name: 'Vera Crawford', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 40, fame: 79, bio: 'Took the year off in 1981 to have a baby. Came back hotter than before. The trades couldn\'t believe it. Her agent could.', trajectory: 0 },
  { name: 'Shoshana Levin', role: 'actor', gender: 'female', archetype: 'Up-and-Comer', age: 27, fame: 41, bio: 'Israeli film school, NYU MFA. First American feature got a four-week theatrical run and a critical avalanche. Three offers pending.', trajectory: 1 },
  { name: 'Edith Whitmore', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 69, fame: 67, bio: 'Was Best Actress runner-up four times in the 60s. Never won. Would still rather not talk about it. Has plenty else to talk about.', trajectory: -1 },
  { name: 'Isabella Bonetti', role: 'actor', gender: 'female', archetype: 'Method Star', age: 34, fame: 67, bio: 'Daughter of a opera singer. Brought Italian intensity to her breakthrough role. Costars learned to clear the floor before her scenes.', trajectory: 1 },
  { name: 'Anita Ferrara', role: 'actor', gender: 'female', archetype: 'Comedy Icon', age: 45, fame: 65, bio: 'Wrote three of her own comedies. Two were hits. One is a cult favorite. Considering directing the fourth.', trajectory: 0 },
  { name: 'Naomi Banks', role: 'actor', gender: 'female', archetype: 'Awards Magnet', age: 39, fame: 78, bio: 'Trained as an opera singer. Brought a voice teacher to a non-singing role and got nominated. The town didn\'t see it coming.', trajectory: 1 },
  { name: 'Ava Calloway', role: 'actor', gender: 'female', archetype: 'Box Office Draw', age: 28, fame: 73, bio: 'The new face of glamour. On every magazine cover in 1984. Quietly turned down two scripts everyone said she should\'ve taken.', trajectory: 1 },
  { name: 'Hedy Beauclair', role: 'actor', gender: 'female', archetype: 'Critics\' Darling', age: 45, fame: 58, bio: 'Plays women who think for a living. Lawyers, scientists, professors. Producers complain her films don\'t sell. Critics complain when there aren\'t more.', trajectory: 0 },
  { name: 'Cicely Banks', role: 'actor', gender: 'female', archetype: 'Industry Veteran', age: 64, fame: 70, bio: 'Came up through the Negro Ensemble Company. First Black woman nominated for Best Actress in two consecutive years. Still working.', trajectory: 0 },

  // ============================================================
  // DIRECTORS — 50 spanning the spectrum from auteur to workhorse
  // ============================================================
  { name: 'Atticus Cole', role: 'director', gender: 'male', archetype: 'Indie Auteur', age: 44, fame: 75, bio: 'Long-take obsessive. Every film a critic\'s puzzle. Has called every studio executive he\'s worked with by their last name only.', trajectory: 0 },
  { name: 'Saul Vance', role: 'director', gender: 'male', archetype: 'Studio Workhorse', age: 58, fame: 65, bio: 'Reliable, on time, on budget. One Best Director nomination, no win. Will never be invited to Cannes. Gets the job done.', trajectory: 0 },
  { name: 'Theodora Marlowe', role: 'director', gender: 'female', archetype: 'Awards Magnet', age: 51, fame: 80, bio: 'Two Oscars, both for international co-productions. The female director the industry points to when asked. She has thoughts about that.', trajectory: 0 },
  { name: 'Quentin Brackett', role: 'director', gender: 'male', archetype: 'Action Hero', age: 39, fame: 70, bio: 'Started as a set carpenter. Choreographs his own action. Studios send him their messy second-unit scripts and watch him fix them.', trajectory: 1 },
  { name: 'Lev Sokolov', role: 'director', gender: 'male', archetype: 'Critics\' Darling', age: 47, fame: 60, bio: 'European exile. Made his name with Cold War art-house. Got a $40M studio budget once. Disaster. They still send him offers.', trajectory: -1 },
  { name: 'Maxine Reeves', role: 'director', gender: 'female', archetype: 'Up-and-Comer', age: 33, fame: 50, bio: 'Music videos for the biggest acts of the early 80s. Just got her first feature greenlit. Visual style is the entire selling point.', trajectory: 1 },
  { name: 'Bishop Donnelly', role: 'director', gender: 'male', archetype: 'Box Office Draw', age: 49, fame: 78, bio: 'Adventure-spectacle specialist. Three of his last five cleared $100M. Studios green-light his ideas before he finishes the pitch.', trajectory: 1 },
  { name: 'Ophelia Sands', role: 'director', gender: 'female', archetype: 'Critics\' Darling', age: 37, fame: 55, bio: 'Made her bones with three small films about women and time. The town keeps offering her thrillers. She keeps making her films.', trajectory: 1 },
  { name: 'Vincent Aldridge', role: 'director', gender: 'male', archetype: 'Comedy Icon', age: 54, fame: 67, bio: 'Defined the studio comedy of the late 70s. Twelve films. Eight hits. Currently between projects, which might be permanent.', trajectory: -1 },
  { name: 'Cyrus Halford', role: 'director', gender: 'male', archetype: 'Industry Veteran', age: 71, fame: 60, bio: 'Old guard from the studio system. Six decades of films. Won his Oscar in 1962 and hasn\'t directed a hit since. Doesn\'t care.', trajectory: -1 },
  { name: 'Mira Calabria', role: 'director', gender: 'female', archetype: 'Awards Magnet', age: 49, fame: 70, bio: 'Italian-American, Brooklyn-born. Three nominations. The one she should have won went to a studio film about something nobody remembers.', trajectory: 0 },
  ...
  { name: 'Howard Booker', role: 'director', gender: 'male', archetype: 'Comedy Icon', age: 60, fame: 65, bio: 'Sitcom king of the 70s, made the leap to features in 1979. Six comedies, all profitable, two beloved. Slowing down to TV again.', trajectory: -1 },
  { name: 'William Sterling', role: 'director', gender: 'male', archetype: 'Studio Workhorse', age: 53, fame: 50, bio: 'Westerns when there were westerns, dramas when there weren\'t. Twenty-six films. None famous. None embarrassing.', trajectory: 0 },
  { name: 'Edward Ardent', role: 'director', gender: 'male', archetype: 'Industry Veteran', age: 75, fame: 55, bio: 'Was the wunderkind of 1958. Now elder statesman. Has a plaque at the DGA. Hasn\'t made a film since 1979. Says he\'s "considering."', trajectory: -1 },
  { name: 'Renata Cabrera', role: 'director', gender: 'female', archetype: 'Critics\' Darling', age: 38, fame: 60, bio: 'Argentinian transplant. Films set in dictatorships, films set in supermarkets. Same eye. Cannes regular. The town doesn\'t quite know what to do with her.', trajectory: 1 },
  ...
  { name: 'Murray Castellano', role: 'director', gender: 'male', archetype: 'Comedy Icon', age: 52, fame: 70, bio: 'Wrote Borscht Belt jokes at 14. Directed his first film at 30. Forty hits later, still pitches the same way: with three jokes and an outline.', trajectory: 0 },
  { name: 'Lee Wong', role: 'director', gender: 'male', archetype: 'Box Office Draw', age: 35, fame: 65, bio: 'Hong Kong action specialist. Two Cantonese films grossed worldwide. Studios paid him triple to come direct an American picture. He took it.', trajectory: 1 },
  { name: 'Paolo Marchetti', role: 'director', gender: 'male', archetype: 'Method Star', age: 49, fame: 58, bio: 'Builds his own sets. Films in available light. The crew either loves him or quits in week two. Three Oscars between his films.', trajectory: 0 },
  { name: 'Margaret Voss', role: 'director', gender: 'female', archetype: 'Studio Workhorse', age: 55, fame: 47, bio: 'Eight features in twelve years. None famous. All competent. Studios call her when their A-list director drops out three weeks before shooting.', trajectory: 0 },
  { name: 'Vincent Donnelly', role: 'director', gender: 'male', archetype: 'Fading Star', age: 64, fame: 38, bio: 'Was the studio\'s favorite in 1972. Five flops in a row killed his deal. Now does TV movies. Has a great script in a drawer.', trajectory: -1 },
  { name: 'Eleanor Whitmore', role: 'director', gender: 'female', archetype: 'Industry Veteran', age: 70, fame: 70, bio: 'Came up as a studio script supervisor in 1947. Got her first film in 1968. Hasn\'t stopped since. Twenty-eight films, three of them masterpieces.', trajectory: -1 },
  { name: 'Cole Booker', role: 'director', gender: 'male', archetype: 'Action Hero', age: 36, fame: 60, bio: 'Stunt coordinator turned director. Makes the action genuinely scary. Studios pay him to "find the real version" of their action scripts.', trajectory: 1 },
  { name: 'Sofia Calabria', role: 'director', gender: 'female', archetype: 'Awards Magnet', age: 43, fame: 75, bio: 'Italian-American, third generation. Films about families and food. Two Oscars. The town calls her "the kid sister of cinema." She\'s 43.', trajectory: 0 },
  { name: 'Henry Frost', role: 'director', gender: 'male', archetype: 'Critics\' Darling', age: 51, fame: 55, bio: 'Fellini disciple. Films about dreams and disappointment. Studios let him make one every four years. He still loses them money.', trajectory: 0 },
  { name: 'Leah Goldberg', role: 'director', gender: 'female', archetype: 'Up-and-Comer', age: 32, fame: 45, bio: 'NYU film school grad. Indie debut got her on the cover of American Film. Three studios bidding for her sophomore picture.', trajectory: 1 },
  { name: 'Howard Halloran', role: 'director', gender: 'male', archetype: 'Box Office Draw', age: 50, fame: 78, bio: 'The studio go-to for tentpole disaster movies. His name above the title sells tickets. His name in the credits sells more.', trajectory: 1 },
  { name: 'Helen Beaumont', role: 'director', gender: 'female', archetype: 'Indie Auteur', age: 39, fame: 50, bio: 'Sixteen-millimeter loyalist. Films about women and silence. The Telluride audience knows her name. The Oscar voters don\'t.', trajectory: 0 },
  ...
  { name: 'Walter Halford', role: 'director', gender: 'male', archetype: 'Studio Workhorse', age: 60, fame: 45, bio: 'Has directed every TV pilot the network has greenlit since 1968. Made eight feature films, all forgotten. Doesn\'t mind.', trajectory: -1 },
  { name: 'Salvatore Ferrara', role: 'director', gender: 'male', archetype: 'Action Hero', age: 41, fame: 64, bio: 'Italian gangster pictures in the 70s. American thriller pictures in the 80s. Same intensity. Critics started taking him seriously around 1982.', trajectory: 1 },

  // ============================================================
  // WRITERS — 50 from script doctors to literary darlings
  // ============================================================
  { name: 'Walter Innes', role: 'writer', gender: 'male', archetype: 'Industry Veteran', age: 70, fame: 35, bio: 'Three Oscars across forty years. Lives in upstate New York. Has never owned a Los Angeles property. Faxes pages in.', trajectory: -1 },
  { name: 'Sara Bellamy', role: 'writer', gender: 'female', archetype: 'Critics\' Darling', age: 41, fame: 45, bio: 'Smart female-led dramas. Adapts her own novels. There\'s a sub-clause in every contract that says she stays on set.', trajectory: 1 },
  { name: 'Roman Castellano', role: 'writer', gender: 'male', archetype: 'Studio Workhorse', age: 53, fame: 30, bio: 'Punch-up specialist. Saved a dozen tentpoles uncredited and prefers it that way. Cashes the checks, doesn\'t take the meetings.', trajectory: 0 },
  { name: 'Harlan Wexler', role: 'writer', gender: 'male', archetype: 'Comedy Icon', age: 47, fame: 42, bio: 'Wrote the biggest comedies of the late 70s. Drinks. Slowing down. The young writers in town still quote his second act structure.', trajectory: -1 },
  { name: 'Imogen Pierce', role: 'writer', gender: 'female', archetype: 'Up-and-Comer', age: 29, fame: 25, bio: 'Black List darling. Three scripts in development at three studios. Nothing greenlit yet. Everyone thinks they discovered her first.', trajectory: 1 },
  { name: 'Tobias Larch', role: 'writer', gender: 'male', archetype: 'Method Star', age: 38, fame: 33, bio: 'Recluse. Spends years on each script. When his films get made they win awards. Refuses to write a sequel of anything.', trajectory: 0 },
  { name: 'Vivienne Marlowe', role: 'writer', gender: 'female', archetype: 'Awards Magnet', age: 51, fame: 50, bio: 'Two Oscars for original screenplay. Adapted her own life into a film and refused to fictionalize the bad parts. Producer cried.', trajectory: 0 },
  { name: 'Carlos Santiago', role: 'writer', gender: 'male', archetype: 'Critics\' Darling', age: 45, fame: 40, bio: 'Cuban-American, wrote three novels before his first script. Adapts magical realism for the screen and somehow makes it work.', trajectory: 1 },
  { name: 'Anna Goldberg', role: 'writer', gender: 'female', archetype: 'Industry Veteran', age: 66, fame: 48, bio: 'Studio contract writer in the 50s. Got out, freelanced, came back, got nominated, got out again. Currently retired. Probably.', trajectory: -1 },
  { name: 'James Halloran', role: 'writer', gender: 'male', archetype: 'Studio Workhorse', age: 55, fame: 32, bio: 'The guy studios call when an action script needs to make sense. Sixteen credits in twelve years. Mostly the second-billed writer.', trajectory: 0 },
  { name: 'Helen Crewe', role: 'writer', gender: 'female', archetype: 'Box Office Draw', age: 39, fame: 55, bio: 'Romcom queen of the early 80s. Three of her scripts opened to $30M+. Studios pay her $400K for an outline.', trajectory: 1 },
  { name: 'Marcus Donnelly', role: 'writer', gender: 'male', archetype: 'Awards Magnet', age: 44, fame: 47, bio: 'Won Best Adapted Screenplay for an unfilmable novel. Still doesn\'t like talking about the book. Has been offered every literary adaptation since.', trajectory: 0 },
  { name: 'Esther Wexler', role: 'writer', gender: 'female', archetype: 'Comedy Icon', age: 49, fame: 52, bio: 'Wrote three of the top-grossing comedies of the 70s. Doesn\'t write anymore. Runs a yoga studio in Topanga. Says she\'s happier.', trajectory: -1 },
  { name: 'Vincent Coleman', role: 'writer', gender: 'male', archetype: 'Action Hero', age: 41, fame: 38, bio: 'Wrote the Cobra trilogy. Knows action structure better than any director he\'s worked with. Still bitter about not getting the directing chair on the third one.', trajectory: 0 },
  { name: 'Diahann Banks', role: 'writer', gender: 'female', archetype: 'Critics\' Darling', age: 43, fame: 35, bio: 'Plays for the Negro Ensemble Company adapted into films. Two of three got made. The third is "in development." Has been for six years.', trajectory: 0 },
  { name: 'Bruce Park', role: 'writer', gender: 'male', archetype: 'Up-and-Comer', age: 27, fame: 28, bio: 'Just sold his first script for $1.2M. The town is watching. Studios want him "in the room." His agent is teaching him how to say no.', trajectory: 1 },
  { name: 'Sammy Levin', role: 'writer', gender: 'male', archetype: 'Industry Veteran', age: 71, fame: 40, bio: 'Has written for every late-night host since 1958. Wrote three films too. Mostly for friends. Knows where every body is buried.', trajectory: -1 },
  { name: 'Lucia Cabrera', role: 'writer', gender: 'female', archetype: 'Method Star', age: 36, fame: 38, bio: 'Researched her last script for two years. Lived with the people she was writing about. The film won Cannes. The people sued.', trajectory: 0 },
  { name: 'Edward Sterling', role: 'writer', gender: 'male', archetype: 'Box Office Draw', age: 46, fame: 50, bio: 'Genre specialist: thrillers, with twists. His scripts have a bidding war attached before they go out. Six produced, five hits.', trajectory: 1 },
  { name: 'Florence Whitlock', role: 'writer', gender: 'female', archetype: 'Has-Been', age: 60, fame: 22, bio: 'Wrote a Best Picture winner in 1968. Hasn\'t had a credit since 1976. Pitches the same kind of movie to anyone who\'ll take her call.', trajectory: -1 },
  { name: 'Lorenzo Marchetti', role: 'writer', gender: 'male', archetype: 'Critics\' Darling', age: 40, fame: 42, bio: 'Italian-American, theater background. Plays-into-films specialist. Three of his three adaptations got nominated. The fourth is a long wait.', trajectory: 1 },
  { name: 'Dorothy Frost', role: 'writer', gender: 'female', archetype: 'Industry Veteran', age: 68, fame: 45, bio: 'Wrote female roles before there was a phrase for it. Two generations of actresses owe her their careers. Won her Oscar at sixty.', trajectory: -1 },
  { name: 'Howard Levin', role: 'writer', gender: 'male', archetype: 'Studio Workhorse', age: 50, fame: 30, bio: 'Has written eighteen scripts that went into production. Has had his name on twelve. The other six were rewritten beyond recognition. He cashed all eighteen checks.', trajectory: 0 },
  { name: 'Beatrice Esposito', role: 'writer', gender: 'female', archetype: 'Awards Magnet', age: 48, fame: 60, bio: 'Three nominations, one win. Plays. Films. A novel coming out next year. Husband is a producer. They never work together.', trajectory: 0 },
  { name: 'Mei Wong', role: 'writer', gender: 'female', archetype: 'Up-and-Comer', age: 28, fame: 32, bio: 'Hong Kong-born, Stanford English. First American sale was a $1.5M spec script. Studio is fast-tracking it. She\'s never been on a set.', trajectory: 1 },
  { name: 'Vito Esposito', role: 'writer', gender: 'male', archetype: 'Comedy Icon', age: 53, fame: 48, bio: 'Brooklyn-born, Yiddish theater background. Made comedy his career in 1962. Made it his fortune in 1974. Still does open mic on Wednesdays.', trajectory: -1 },
  { name: 'Constance Pemberton', role: 'writer', gender: 'female', archetype: 'Critics\' Darling', age: 42, fame: 38, bio: 'Adapts difficult novels for the screen. Three projects, three festival darlings. The town respects her. Doesn\'t hire her enough.', trajectory: 0 },
  { name: 'Stanley Whitmore', role: 'writer', gender: 'male', archetype: 'Industry Veteran', age: 73, fame: 50, bio: 'Wrote his first script in 1955. Wrote his last in 1978. Now a guest lecturer at the AFI. Tells the same anecdotes. Students take notes anyway.', trajectory: -1 },
  { name: 'Rosalind Cabrera', role: 'writer', gender: 'female', archetype: 'Action Hero', age: 38, fame: 35, bio: 'Action-thriller specialist. Female. The town doesn\'t quite believe it. Studios pay her well anyway. Five credits, three were hits.', trajectory: 1 },
  { name: 'Mordecai Goldberg', role: 'writer', gender: 'male', archetype: 'Method Star', age: 56, fame: 45, bio: 'Spent four years in Israel researching his last script. The film took another five years to make. Won three Oscars when it finally did.', trajectory: 0 },
  { name: 'Gabriela Rivera', role: 'writer', gender: 'female', archetype: 'Up-and-Comer', age: 30, fame: 40, bio: 'Mexican-American screenwriter. First feature script just sold for $800K. Studios circling. She wants to direct it. They\'re negotiating.', trajectory: 1 },
  { name: 'Reese Beaumont', role: 'writer', gender: 'male', archetype: 'Box Office Draw', age: 39, fame: 55, bio: 'Comedy specialist. Six produced screenplays, five profitable. Talks fast, writes faster. The Lakers playoff schedule shapes his deadlines.', trajectory: 1 },
  { name: 'Helen Tanaka', role: 'writer', gender: 'female', archetype: 'Critics\' Darling', age: 47, fame: 42, bio: 'Japanese-American writer. Adapts contemporary American fiction. Two Oscar nominations for adapted screenplay. No win. Yet.', trajectory: 0 },
  { name: 'Joseph Cassidy', role: 'writer', gender: 'male', archetype: 'Studio Workhorse', age: 52, fame: 35, bio: 'A working writer for thirty years. Twenty credits. None famous. None terrible. Bought a house in Pacific Palisades. Calls that the win.', trajectory: 0 },
  { name: 'Akiko Park', role: 'writer', gender: 'female', archetype: 'Method Star', age: 35, fame: 36, bio: 'Lives in a cabin in Big Sur. Submits scripts every two years. Each one a Black List entry. Each one eventually made by a famous director.', trajectory: 1 },
  { name: 'Edward Donnelly', role: 'writer', gender: 'male', archetype: 'Awards Magnet', age: 58, fame: 55, bio: 'Two Best Original Screenplay wins. Writes about war and grief. Refuses to write anything funny. The town stopped asking in 1979.', trajectory: 0 },
  { name: 'Naomi Coleman', role: 'writer', gender: 'female', archetype: 'Comedy Icon', age: 41, fame: 60, bio: 'Wrote three of the highest-grossing comedies of the early 80s. Started in stand-up. Brought a comedian\'s ear to dialogue. Studios fight for her.', trajectory: 1 },
  { name: 'Howard Sokolov', role: 'writer', gender: 'male', archetype: 'Critics\' Darling', age: 49, fame: 40, bio: 'Soviet defector who learned English by watching American films. Now writes them. There\'s always a wedding scene. Always.', trajectory: 0 },
  { name: 'Carmen Whitlock', role: 'writer', gender: 'female', archetype: 'Up-and-Comer', age: 26, fame: 33, bio: 'Recent USC MFA grad. Sold her thesis script for $600K. Studio is rewriting it without her. She\'s already onto the next one.', trajectory: 1 },
  { name: 'Walter Mandelbaum', role: 'writer', gender: 'male', archetype: 'Has-Been', age: 64, fame: 25, bio: 'Wrote three of the most-quoted comedies of the 60s. Hasn\'t sold a script since 1979. Pitches every year. Network execs love seeing him for the stories.', trajectory: -1 },
  { name: 'Cicely Robinson', role: 'writer', gender: 'female', archetype: 'Industry Veteran', age: 65, fame: 50, bio: 'Fought to write Black-led films when nobody wanted them. Won. Two of her scripts became Best Picture nominees. Got the credit. Eventually.', trajectory: -1 },
  { name: 'Frank Ardent', role: 'writer', gender: 'male', archetype: 'Box Office Draw', age: 44, fame: 52, bio: 'Genre specialist. Horror in the 70s, sci-fi in the 80s. His scripts have a built-in opening weekend. Studios outbid each other.', trajectory: 1 },
  { name: 'Eleanor Calabria', role: 'writer', gender: 'female', archetype: 'Awards Magnet', age: 53, fame: 58, bio: 'Italian-American, third generation. Wrote a script every studio passed on for ten years. Won Best Original when it finally got made. Made the rounds in person.', trajectory: 0 },
  { name: 'Vincent Park', role: 'writer', gender: 'male', archetype: 'Method Star', age: 39, fame: 38, bio: 'Holes up in a hotel room for six weeks, emerges with a finished draft. Refuses notes. Won an Oscar anyway. Refused notes again next time.', trajectory: 0 },
  { name: 'Pauline Booker', role: 'writer', gender: 'female', archetype: 'Industry Veteran', age: 70, fame: 38, bio: 'Wrote her first film in 1957. Fifty-two credits across forty years. Three Oscar nominations. No win. The Academy keeps trying.', trajectory: -1 },
  { name: 'Antonio Bonetti', role: 'writer', gender: 'male', archetype: 'Studio Workhorse', age: 47, fame: 30, bio: 'Twelve action-thriller scripts in twelve years. All produced. Two cleared $50M. The middle 60% paid the bills. He\'s fine with that.', trajectory: 0 },
  { name: 'Sofia Sands', role: 'writer', gender: 'female', archetype: 'Critics\' Darling', age: 33, fame: 42, bio: 'Wrote a play that ran off-Broadway. Wrote the screen adaptation. Both nominated for the year\'s top prizes. Now studios send her novels to adapt.', trajectory: 1 },
  { name: 'Spencer Halloran', role: 'writer', gender: 'male', archetype: 'Industry Veteran', age: 71, fame: 35, bio: 'Wrote one of the great American screenplays of 1962. Wrote eight more across two decades, all forgotten. Lives modestly. Tips well.', trajectory: -1 },
  { name: 'Anna Wexler', role: 'writer', gender: 'female', archetype: 'Up-and-Comer', age: 28, fame: 30, bio: 'Sold her first spec at twenty-five. Studio is fast-tracking it. She\'s already hired three other writers to consult on her sophomore project.', trajectory: 1 },
  { name: 'Henry Reeves', role: 'writer', gender: 'male', archetype: 'Comedy Icon', age: 57, fame: 55, bio: 'Wrote five of the funniest movies ever made. Says it himself, fairly. Slowing down to occasional rewrites. Spends winters in Italy.', trajectory: -1 },

  // ============================================================
  // PRODUCERS — 50 from indie shepherds to tentpole tycoons
  // ============================================================
  { name: 'Cyrus Halford', role: 'producer', gender: 'male', archetype: 'Industry Veteran', age: 71, fame: 55, bio: 'Old guard. Built three studios. Pulls cast on talent rather than money. The last person in town who still takes a meeting in person.', trajectory: -1 },
  { name: 'Mira Calabria', role: 'producer', gender: 'female', archetype: 'Awards Magnet', age: 49, fame: 60, bio: 'Indie producer who got rich. Specializes in challenging material. Two Oscar nominations for Best Picture. No win yet.', trajectory: 0 },
  { name: 'Bishop Donnelly', role: 'producer', gender: 'male', archetype: 'Box Office Draw', age: 56, fame: 65, bio: 'Tentpole specialist. Three of the top-ten grossers of the 70s have his name on them. Drives a car the same color as the money.', trajectory: 0 },
  { name: 'Helena Frost', role: 'producer', gender: 'female', archetype: 'Studio Workhorse', age: 44, fame: 48, bio: 'Studio executive turned independent. Six films a year. All profitable. The trades call her "the most dangerous woman in town" — she likes that.', trajectory: 1 },
  { name: 'Vincent Aldridge', role: 'producer', gender: 'male', archetype: 'Comedy Icon', age: 51, fame: 50, bio: 'Frat-pack producer. Knows his lane. Owns a beach house and a Sunday morning brunch table at the Polo Lounge.', trajectory: 0 },
  { name: 'Ophelia Sands', role: 'producer', gender: 'female', archetype: 'Up-and-Comer', age: 36, fame: 40, bio: 'New money, taste for prestige. Has eight films in development and the patience to see all of them through. Or so she says.', trajectory: 1 },
  { name: 'Marcus Whitlock', role: 'producer', gender: 'male', archetype: 'Critics\' Darling', age: 47, fame: 45, bio: 'Specializes in producing first-time directors. Five of his discoveries went on to win Best Director. He keeps the list in his desk.', trajectory: 0 },
  { name: 'Eleanor Castellano', role: 'producer', gender: 'female', archetype: 'Awards Magnet', age: 58, fame: 70, bio: 'Three Best Picture wins. Came from agency rep to producer in 1976. Has a reputation for never losing a battle with a director.', trajectory: 0 },
  { name: 'Lorenzo Esposito', role: 'producer', gender: 'male', archetype: 'Industry Veteran', age: 73, fame: 60, bio: 'Brooklyn boy who ran a studio in the 60s. Got pushed out, came back independent, made better films than the studio did. Now retired-ish.', trajectory: -1 },
  { name: 'Sammy Coleman', role: 'producer', gender: 'male', archetype: 'Action Hero', age: 49, fame: 62, bio: 'Action-tentpole specialist. Used to be a stunt coordinator. Knows what the practical effects budget can actually buy.', trajectory: 1 },
  { name: 'Imogen Marlowe', role: 'producer', gender: 'female', archetype: 'Critics\' Darling', age: 40, fame: 50, bio: 'Boutique producer. Three pictures a year, all of them at festivals. None of them make money. Still gets calls from every actor who matters.', trajectory: 1 },
  { name: 'Walter Beaumont', role: 'producer', gender: 'male', archetype: 'Studio Workhorse', age: 60, fame: 45, bio: 'Production manager turned producer. Twenty-two credits, all on time and under budget. The studios call him "the cleaner."', trajectory: 0 },
  { name: 'Diane Park', role: 'producer', gender: 'female', archetype: 'Box Office Draw', age: 42, fame: 65, bio: 'Korean-American producer who broke through with a $200K horror movie that made $40M. Now signs three-picture deals.', trajectory: 1 },
  { name: 'Howard Robinson', role: 'producer', gender: 'male', archetype: 'Awards Magnet', age: 56, fame: 67, bio: 'Won Best Picture for an unfilmable book everyone said couldn\'t be made. Spent ten years getting the rights. Worth it.', trajectory: 0 },
  { name: 'Carmen Mendoza', role: 'producer', gender: 'female', archetype: 'Up-and-Comer', age: 34, fame: 42, bio: 'First Mexican-American woman to produce a Best Picture nominee. Used the heat to set up a deal at every studio in town.', trajectory: 1 },
  { name: 'Murray Goldberg', role: 'producer', gender: 'male', archetype: 'Comedy Icon', age: 52, fame: 55, bio: 'Sketch comedy producer turned movie producer. Made eight comedies that grossed over $50M each. Has a gold record for the soundtrack of one.', trajectory: 0 },
  { name: 'Edith Pemberton', role: 'producer', gender: 'female', archetype: 'Industry Veteran', age: 66, fame: 50, bio: 'Got her start as a script supervisor in 1946. Producing since 1968. Forty films later, she still answers her own phone.', trajectory: -1 },
  { name: 'Vito Marchetti', role: 'producer', gender: 'male', archetype: 'Critics\' Darling', age: 45, fame: 48, bio: 'Italian-American producer who specializes in adapting plays. Refuses to commission original screenplays. Says novelists ruin their own books.', trajectory: 0 },
  ...
  { name: 'Beatrice Sokolov', role: 'producer', gender: 'female', archetype: 'Industry Veteran', age: 64, fame: 55, bio: 'Russian-born, came to America in 1957. Producing since 1968. Knows every line producer in town. They all owe her favors.', trajectory: -1 },
  { name: 'Jack Ferrara', role: 'producer', gender: 'male', archetype: 'Comedy Icon', age: 45, fame: 53, bio: 'Frat-house comedy producer. Knows his demo. Knows his budget. Knows his marketing tag. Six of his last seven made money.', trajectory: 0 },
  { name: 'Sara Goldberg', role: 'producer', gender: 'female', archetype: 'Critics\' Darling', age: 47, fame: 50, bio: 'Boutique producer with a Cannes habit. Three Palme d\'Or nominations. Studio executives can\'t fund her films but show up to her parties.', trajectory: 0 },
  { name: 'Diego Rivera', role: 'producer', gender: 'male', archetype: 'Up-and-Comer', age: 33, fame: 42, bio: 'Mexican film producer making his American debut. First English-language project just got a major studio bid. He\'s asking for autonomy.', trajectory: 1 },
  { name: 'Helen Sterling', role: 'producer', gender: 'female', archetype: 'Box Office Draw', age: 53, fame: 67, bio: 'Specializes in family films that gross $150M. Seven of those in twelve years. Disney executives keep trying to hire her away.', trajectory: 1 },
  { name: 'Joseph Whitlock', role: 'producer', gender: 'male', archetype: 'Industry Veteran', age: 70, fame: 58, bio: 'A producer for fifty years. Made his fortune on a single mid-70s drama everyone forgot. Hasn\'t had to work in a decade. Still does.', trajectory: -1 },
  { name: 'Lucia Cabrera', role: 'producer', gender: 'female', archetype: 'Method Star', age: 38, fame: 45, bio: 'Lives on her sets. Three productions a year. She\'s on every one for every day. Crews either burn out or never want to work for anyone else.', trajectory: 1 },
  { name: 'Henry Whitmore', role: 'producer', gender: 'male', archetype: 'Awards Magnet', age: 55, fame: 60, bio: 'Specializes in director-driven prestige pictures. Has produced five Best Director winners. Always lets the director have the credit.', trajectory: 0 },
  { name: 'Connie Park', role: 'producer', gender: 'female', archetype: 'Up-and-Comer', age: 29, fame: 38, bio: 'Korean-American producer. Just produced her first feature for $1M. It made $25M. Studios are calling. She\'s vetting them carefully.', trajectory: 1 },
  { name: 'Sammy Booker', role: 'producer', gender: 'male', archetype: 'Action Hero', age: 50, fame: 55, bio: 'Action-thriller specialist. Produced six films grossing over $100M combined. Made a fortune. Doesn\'t spend it. Drives a 1976 Honda.', trajectory: 1 },
  { name: 'Audrey Calloway', role: 'producer', gender: 'female', archetype: 'Critics\' Darling', age: 43, fame: 47, bio: 'Boutique producer specializing in literary adaptations. Three festival prizes. The studios won\'t fund her. Foreign money will.', trajectory: 0 },
  { name: 'Marcus Park', role: 'producer', gender: 'male', archetype: 'Box Office Draw', age: 41, fame: 65, bio: 'Action-tentpole specialist. Brings projects in under budget and over expectation. Studios let him do whatever he wants.', trajectory: 1 },
  { name: 'Margaret Coleman', role: 'producer', gender: 'female', archetype: 'Studio Workhorse', age: 57, fame: 42, bio: 'Has produced TV movies of the week since 1972. Knows every casting agent in town. Three feature credits. None famous. None embarrassing.', trajectory: 0 },
  { name: 'Tobias Esposito', role: 'producer', gender: 'male', archetype: 'Method Star', age: 45, fame: 48, bio: 'Produces one film every five years. Each one a critical event. Each one a financial loss. Funds them with his real estate portfolio.', trajectory: 0 },
  { name: 'Cicely Banks', role: 'producer', gender: 'female', archetype: 'Awards Magnet', age: 55, fame: 62, bio: 'Brought five Black-led prestige films to the Oscars in twelve years. Two won. Three lost to films nobody remembers anymore.', trajectory: 0 },
  { name: 'Howard Whitlock', role: 'producer', gender: 'male', archetype: 'Industry Veteran', age: 67, fame: 50, bio: 'Was a studio executive in the 60s. Independent producer since 1974. Twenty-eight features. Two cleared $100M. The other twenty-six broke even.', trajectory: -1 },
  { name: 'Renata Bonetti', role: 'producer', gender: 'female', archetype: 'Up-and-Comer', age: 34, fame: 40, bio: 'Italian-American producer. Produced her first feature at thirty. The next at thirty-two. The third bid is happening now. Three offers on the table.', trajectory: 1 },
  { name: 'William Castellano', role: 'producer', gender: 'male', archetype: 'Comedy Icon', age: 48, fame: 50, bio: 'Comedy producer who made his name with Saturday Night Live transplants. Studio loves him because he opens films cheap and they explode wide.', trajectory: 0 },
  { name: 'Phylicia Robinson', role: 'producer', gender: 'female', archetype: 'Critics\' Darling', age: 39, fame: 43, bio: 'Producer of Black-led indie films. Three festival prizes. Has been pitching a Black biopic for seven years. Every studio passes.', trajectory: 1 },
  { name: 'Carlos Marchetti', role: 'producer', gender: 'male', archetype: 'Box Office Draw', age: 47, fame: 60, bio: 'Specializes in international co-productions. His films play everywhere. Made his fortune on a Mexico-USA-Spain pic that grossed worldwide.', trajectory: 1 },
  { name: 'Charles Frost', role: 'producer', gender: 'male', archetype: 'Has-Been', age: 62, fame: 22, bio: 'Was a top studio producer in the 70s. Hasn\'t had a hit since 1979. Pitches every Tuesday. Still gets meetings on his name alone.', trajectory: -1 },
  { name: 'Naomi Levin', role: 'producer', gender: 'female', archetype: 'Industry Veteran', age: 65, fame: 55, bio: 'Came up in the studio system. Producer since 1962. Has worked with every A-list director still alive. Doesn\'t take meetings before noon.', trajectory: -1 },
  { name: 'Antonio D\'Angelo', role: 'producer', gender: 'male', archetype: 'Method Star', age: 41, fame: 45, bio: 'Lives on his productions for the entire shoot. Three pictures in eight years. All Best Picture nominees. None winners.', trajectory: 1 },
  { name: 'Hedy Whitlock', role: 'producer', gender: 'female', archetype: 'Awards Magnet', age: 50, fame: 65, bio: 'Won Best Picture for a film about her own family. Spent fifteen years getting it made. Hasn\'t produced anything since. Says she\'s done.', trajectory: 0 },
  { name: 'Salvatore Bonetti', role: 'producer', gender: 'male', archetype: 'Action Hero', age: 53, fame: 52, bio: 'Produces action pictures with old-school stunt work. Refuses CGI. Studios indulge him because his films open. He cracks his knuckles and says they will.', trajectory: 0 },
];
...
function seedWorldNPCs(startYear) {
  ...
  // Pull 15 curated NPCs (random subset, varies per game). Pool is ~250 so
  // any given career meets a small slice, with high replay variety.
  const curatedShuffled = CURATED_NPCS.slice().sort(() => Math.random() - 0.5);
  const curatedCount = Math.min(15, curatedShuffled.length);
